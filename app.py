...
st.set_page_config(page_title="Diabetes Predictor App", page_icon=None, layout='centered', initial_sidebar_state='auto')
...
def inference(row, scaler, model, cols):
    ...
    else: return "This person has high chances of having chronic disease diabetics!"
...
image = Image.open('diabeteee.jpeg')
